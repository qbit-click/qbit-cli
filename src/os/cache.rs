...
///
/// Honors `QBIT_UPDATE_CACHE_DIR` as an override, primarily so
/// integration tests can point the cache at a temp directory instead
/// of the real user config/cache location.
